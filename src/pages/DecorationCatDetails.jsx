...
function DecorationCatDetails() {
  ...
  const handleCheckout = (subCategory, product) => {
    const stateData = {from: window.location.pathname, subCategory, product, totalAmount , orderType, catValue , selectedAddOnProduct,itemQuantities };
  ...
  return (
   ...
   <ul className="decoration-addons">
    ...
    <div className="addon-sec">
      ...
      <h6>Customisations 
      <span onClick={showAddOnmodal} style={{ marginLeft:"6px"}}>
