...
function Checkout() {
    ...
    const {subCategory, product, orderType, orderDetails} = location.state || {};


    useEffect(() => {
        const storedBasePrice = localStorage.getItem('basePrice');
        const storedAddonsTotal = localStorage.getItem('addonsTotal');

        setBasePrice(storedBasePrice ? parseFloat(storedBasePrice) : 0);
        setAddonsTotal(storedAddonsTotal ? parseFloat(storedAddonsTotal) : 0);
    }, []);
        ...
        <div className="App">
            {
                window.innerWidth > 800 ?
                    <div style={{padding: "1% 2%", backgroundColor: "#edededc9"}}>
                        <div style={{display: "flex", alignItems: "start", margin: "0 !important", padding: "10px 0"}}
                            ...
                            <div style={{
                                ...
                                <div style={{display: 'flex', margin: "8px 0px 10px", flexDirection: "row"}}
                                    ...
                                    <CustomTimePicker handleTimeSlotChange={handleTimeSlotChange}
                                ...
                                {combinedDateTimeError &&
                                    <p className="text-danger" style={{fontSize: '12px', marginBottom: "0px"}}>The
                                        selected date and time must be at least 24 hours from now.</p>}
                                ...
                                <div>
                                    <div style={{display: "flex", justifyContent: "center", flexDirection: "column"}}
                                        ...
                                        />
                                        {addressError &&
                                            <p className={`p-0 m-0 ${addressError ? "text-danger" : ""}`}>This field is
                                                required!</p>}
                                    </div>
                                    <div style={{display: "flex", justifyContent: "center", flexDirection: "column"}}
                                         className='checkoutInputType'>
                                        ...
                                        />
                                        {pinCode &&
                                            <p className={`p-0 m-0 ${pinCodeError ? "text-danger" : "text-success"}`}>{`Service ${pinCodeError ? 'not' : ''} available in your area!`}</p>}
                                        {pincodeReqError &&
                                            <p className={`p-0 m-0 ${pincodeReqError ? "text-danger" : ""}`}>This field
                                                is required!</p>}
                                    </div>
                                    <div style={{display: "flex", justifyContent: "center", flexDirection: "column"}}
                                         className='checkoutInputType'>
                                        ...
                                        <select value={city} className=' rounded border border-1 p-1'
                                        ...
                                        {cityError &&
                                            <p className={`p-0 m-0 ${cityError ? "text-danger" : ""}`}>This field is
                                                required!</p>}
                                    </div>
                                </div>
                                <button onClick={onContinueClick} className="blue-btn chkeoutBottun">Confirm Order
                                </button>
                            </div>

                            <div className="rightSeccheckout" style={{
                                boxShadow: "0 1px 8px rgba(0,0,0,.18) ",
                                padding: "20px",
                                backgroundColor: "#fff",
                                borderRadius: "20px",
                                ...
                                <div className='rightsecdecinner decoration'>
                                    ...
                                    <div className='d-flex flex-column flex-lg-row'>
                                        <div>
                                            <img className='checkoutRightImg'
                                        ...
                                        <div className='prod-detailsp'>
                                            ...
                                            <div style={{
                                                ...
                                                <div>
                                                    {orderDetails && (
                                                        <ul style={{padding: 0, margin: "8px 0", marginLeft: '15px'}}>
                                    ...
                                    <div>
                                        ...
                                        <div
                                            className='d-flex justify-content-center align-items-center need-more-info-sec'>
                                            <h5 className=''>Need more info?</h5>
                                            <button onClick={contactUsRedirection} style={{
                                                border: "2px solid rgb(157, 74, 147)",
                                                color: "rgb(157, 74, 147)"
                                            }} className=' rounded-5 ms-1 contactus-redirection'>Contact Us
                                            </button>
                                        </div>
                                        ...
                                        <div className='px-1 py-3 border rounded my-2 cancellatiop-policy' style={{
                                            ...
                                            <p style={{fontSize: "13px", color: "rgb(157, 74, 147)"}}
                                               className=' text-center m-1'>Cancellation and order change policy</p>
                                            <p style={{fontSize: "13px", color: "rgb(157, 74, 147)"}}
                                               className='m-1'>Till the order is not assign to the service provider ,
                                                100% of the amount will be refunded, othewise 50%of the advance will be
                                                deducted as a cancellation charges to componsate the service
                                                provider. </p>
                                            <p style={{fontSize: "13px", color: "rgb(157, 74, 147)"}}
                                               className='m-1'>The order cannot be edited after paying the advance
                                                customers can cancel the order and replace it with a new order with the
                                                required changes.</p>
                                        </div>
                    ...
                    :
                    <div style={{padding: "1% 2%", backgroundColor: "#edededc9", position: "relative"}}
                            ...
                            <div>
                                ...
                                <div style={{display: 'flex', margin: "8px 0px 10px", flexDirection: "row"}}
                                    ...
                                    <CustomTimePicker handleTimeSlotChange={handleTimeSlotChange}
                                                      ...
                                                      selectedTimeSlotError={selectedTimeSlotError}/>
                                    {combinedDateTimeError &&
                                        <p className="text-danger" style={{fontSize: '12px'}}>The selected date and time
                                            must be at least 24 hours from now.</p>}
                                </div>
                                ...
                                <div className="rightSeccheckout" style={{
                                    ...
                                    <div className='rightcheckoutsec'>
                                        <div style={{
                                            ...
                                            {/*<p>Product Price: ₹ {basePrice} {basePrice}</p>
                        <p>Add-Ons Total: ₹ {addonsTotal}{addonsTotal}</p>
                        <p>Total Price: ₹ {basePrice + addonsTotal} </p>*/}
                                        </div>
                                        <div style={{
                                            display: "flex",
                                            justifyContent: "space-between",
                                            ...
                                            <p style={{
                                                ...
                                                fontSize: "16px",
                                                fontWeight: 700
                                            }}>₹ {Math.round(product.price * 0.3)}</p>
                                        </div>
                                        <div style={{
                                            display: "flex",
                                            padding: 7,
                                        ...
                                        <div
                                            ...
                                            />
                                            {addressError &&
                                                <p className={`p-0 m-0 ${addressError ? "text-danger" : ""}`}>This field
                                                    is required!</p>}
                                        </div>
                                        <div
                                            style={{display: "flex", justifyContent: "center", flexDirection: "column"}}
                                            ...
                                            {pinCode &&
                                                <p className={`p-0 m-0 ${pinCodeError ? "text-danger" : "text-success"}`}>{`Service ${pinCodeError ? 'not' : ''} available in your area!`}</p>}
                                            {pincodeReqError &&
                                                <p className={`p-0 m-0 ${pincodeReqError ? "text-danger" : ""}`}>This
                                                    field is required!</p>}
                                        </div>
                                        <div
                                            style={{display: "flex", justifyContent: "center", flexDirection: "column"}}
                                        ...
                                        <div className='checkoutInputType border-1 rounded-4  my-3' style={{
                                            display: "flex",
                                            justifyContent: "center",
                                            flexDirection: "column"
                                        }}>
                                ...
                                <div className='d-flex justify-content-center align-items-center mt-3 mb-0'>
                                    <h5 className=''>Need more info?</h5>
                                    <button onClick={contactUsRedirection}
                                            style={{border: "2px solid rgb(157, 74, 147)", color: "rgb(157, 74, 147)"}}
                                            className=' rounded-5 ms-1 contactus-redirection'>Contact Us
                                    </button>
                                </div>
                                ...
                                <div className='px-1 py-3 border rounded my-2 cancellatiop-policy' style={{
                                    ...
                                    <p style={{fontSize: "13px", color: "rgb(157, 74, 147)"}}
                                       className=' text-center m-1'>Cancellation and order change policy</p>
                                    <p style={{fontSize: "13px", color: "rgb(157, 74, 147)"}} className='m-1'>Till the
                                        order is not assign to the service provider , 100% of the amount will be
                                        refunded, othewise 50%of the advance will be deducted as a cancellation charges
                                        to componsate the service provider. </p>
                                    <p style={{fontSize: "13px", color: "rgb(157, 74, 147)"}} className='m-1'>The order
                                        cannot be edited after paying the advance customers can cancel the order and
                                        replace it with a new order with the required changes.</p>
                                </div>
                        ...
                        {window.innerWidth < 800 ?
                            ...
                            >
                                ...
                                <button className="blue-btn chkeoutBottun" onClick={onContinueClick}>Confirm Order
                                </button>
                            </div>
                            :
                            null
...
export const CustomDatePicker = ({
    ...
    return (
        <div
            className={`d-flex flex-column border border-1 rounded-4  timepkerSec ${combinedDateTimeError ? 'border-danger' : ''} `}>
            <p style={{marginBottom: "4px", color: "rgb(146, 82, 170)", fontSize: "12px"}} className='p-0 m-0'>Booking
                Date</p>
            <Dropdown show={showDatePicker} onToggle={toggleDatePicker} className='border-none p-0'>
                <Dropdown.Toggle
                    ...
                    <span style={{fontSize: '12px'}}
                          className='m-0 p-0 '>{selectedDate ? selectedDate.toLocaleDateString() : 'Select Date'}</span>
                </Dropdown.Toggle>
...
export const CustomTimePicker = ({
    ...
    return (
        <div
            className={`timepkerSec d-flex flex-column border border-1 ${combinedDateTimeError ? 'border-danger' : ''}  ${selectedTimeSlotError ? 'border-danger' : ""} rounded-4 `}>
            <p style={{marginBottom: "4px", color: "rgb(146, 82, 170)", fontSize: "12px"}} className='p-0 m-0'>Select
                Time</p>
            <div>
                <Form.Control
                    as="select"
